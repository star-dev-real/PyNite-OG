from sanic import Blueprint, empty, raw, json
...
@bp.get("/fortnite/api/cloudstorage/system")
...
@bp.get("/fortnite/api/cloudstorage/system/<file:str>")
...
@bp.get("/fortnite/api/cloudstorage/user/<account_id:path>/<file:str>")
...
@bp.get("/fortnite/api/cloudstorage/user/<account_id:str>")
...
@bp.put("/fortnite/api/cloudstorage/user/<account_id:path>/<file:str>")
